      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        {activeSlide === 1 && (
          <>
            ...
            <p className="mx-auto mt-0 mb-4 max-w-[640px] text-center text-white hero-subtitle">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
            </p>
                <button
          type="button"
          className="relative mt-0 inline-block bg-[#2bb6b6] px-8 py-4 uppercase hero-btn-text"
        >
          Learn More
        </button>
          </>
        ...
        {activeSlide === 2 && (
          <>
            ...
            <p className="mx-auto mt-0 mb-0 max-w-[640px] text-center text-white hero-subtitle">
             Duis aute irure dolor in reprehenderit in voluptate velit esse, consectetur adipisicing elit
            </p>
          </>
        )}
