...
const Navbar = () => {
  ...
  return (
    <header className="sticky py-5 z-50 w-full bg-white shadow-sm border-b border-gray-100">
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <nav className="hidden lg:flex items-center space-x-1 lg:space-x-2 text-sm tracking-wide text-gray-800 font-serif">
          ...
          <div className="lg:hidden flex items-center">
            <button
              ...
              className="text-gray-600 hover:text-[#2eb8b8] focus:outline-none cursor-pointer"
        ...
        <div className="lg:hidden bg-white border-t border-gray-100 shadow-lg">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 font-serif">
            ...
            <a 
              ...
              className={`font_family block px-3 py-2 rounded-md text-base ${activeLink === 'home' ? 'text-[#2eb8b8] font-bold' : 'text-gray-600 hover:bg-gray-50 hover:text-[#2eb8b8]'}`}
            >
              HOME
            </a>
            ...
            <a 
              ...
              className={`font_family block px-3 py-2 rounded-md text-base ${activeLink === 'portfolio' ? 'text-[#2eb8b8] font-bold' : 'text-gray-600 hover:bg-gray-50 hover:text-[#2eb8b8]'}`}
            >
              PORTFOLIO
            </a>
            ...
            <a 
              ...
              className={`font_family block px-3 py-2 rounded-md text-base ${activeLink === 'services' ? 'text-[#2eb8b8] font-bold' : 'text-gray-600 hover:bg-gray-50 hover:text-[#2eb8b8]'}`}
            >
              SERVICES
            </a>
            ...
            <a 
              ...
              className={`font_family block px-3 py-2 rounded-md text-base ${activeLink === 'team' ? 'text-[#2eb8b8] font-bold' : 'text-gray-600 hover:bg-gray-50 hover:text-[#2eb8b8]'}`}
            >
              TEAM
            </a>
            ...
            <a 
              ...
              className={`font_family block px-3 py-2 rounded-md text-base ${activeLink === 'about' ? 'text-[#2eb8b8] font-bold' : 'text-gray-600 hover:bg-gray-50 hover:text-[#2eb8b8]'}`}
            >
              ABOUT
            </a>
            ...
            <a 
              ...
              className={`font_family block px-3 py-2 rounded-md text-base ${activeLink === 'blog' ? 'text-[#2eb8b8] font-bold' : 'text-gray-600 hover:bg-gray-50 hover:text-[#2eb8b8]'}`}
            >
              BLOG
            </a>
            ...
            <a 
              ...
              className={`font_family block px-3 py-2 rounded-md text-base ${activeLink === 'contact' ? 'text-[#2eb8b8] font-bold' : 'text-gray-600 hover:bg-gray-50 hover:text-[#2eb8b8]'}`}
            >
              CONTACT US
            </a>
