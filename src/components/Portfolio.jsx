...
const Portfolio = () => {
  ...
  return (
    <section                                           
      id="portfolio"
      className="py-38.5 bg-[#f8f9fa] relative bg-cover bg-center bg-no-repeat"
    >
      <div className="absolute inset-0 bg-white/70 back_img"></div>

      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <div className="text-center mb-12">
          <h2 className="font_family text-[rgb(0,0,0)] text-[45px] font-[700] leading-[49.5px] uppercase mb-0">
            Our Portfolio
          </h2>
       ...
       <div className="border-y border-gray-300/60 py-6 mb-12">
          <div className="flex flex-wrap justify-center gap-0 md:gap-0 font-semibold uppercase">
            
            <button
              onClick={() => setActiveFilter('All')}
              className={`font_family font-[400] px-4 py-2 text-[18px] leading-[25.7143px] ${
            ...
            <button
              ...
              className={`font_family px-6 py-2 font-[400] text-[18px] leading-[25.7143px] ${
                activeFilter === 'Web Design' ? 'bg-[#2eb8b8] text-white -skew-x-[20deg]' : 'text-[rgb(0,0,0)] hover:text-[#2eb8b8] hover:bg-gray-100'
              }`}
            >
              <span className={activeFilter === 'Web Design' ? 'skew-x-[20deg] inline-block' : ''}>Web Design</span>
            </button>
            ...
            >
              <span className={activeFilter === 'Photography' ? 'skew-x-[20deg] inline-block' : ''}>Photography</span>
            </button>
            ...
            >
              <span className={activeFilter === 'Illustration' ? 'skew-x-[20deg] inline-block' : ''}>Illustration</span>
            </button>

            <button
              onClick={() => setActiveFilter('Branding')}
              className={`text-lg font_family px-6 py-2 font-[400]  leading-[25.7143px] ${
                activeFilter === 'Branding' ? 'bg-[#2eb8b8] text-white -skew-x-[20deg]' : 'text-[rgb(0,0,0)] hover:text-[#2eb8b8] hover:bg-gray-100'
              }`}
            >
              <span className={activeFilter === 'Branding' ? 'skew-x-[20deg] inline-block' : ''}>Branding</span>
            </button>
          ...
          {(activeFilter === 'All' || activeFilter === 'Web Design') && (
            <div className="group relative overflow-hidden bg-white shadow-sm hover:shadow-md break-inside-avoid">
              ...
              <div className="absolute inset-0 bg-[#2eb8b8]/80 opacity-0 group-hover:opacity-100 flex flex-col items-center justify-center cursor-pointer">
                ...
                <h3 className="text-white mt-4 font-semibold tracking-wider uppercase text-sm">Yellow Flyer Design</h3>
                <p className="text-white/80 text-xs mt-1 italic">Web Design</p>
              </div>
          ...
          {(activeFilter === 'All' || activeFilter === 'Branding') && (
            <div className="group relative overflow-hidden bg-white shadow-sm hover:shadow-md break-inside-avoid">
              ...
              <div className="absolute inset-0 bg-[#2eb8b8]/80 opacity-0 group-hover:opacity-100 flex flex-col items-center justify-center cursor-pointer">
                ...
                <h3 className="text-white mt-4 font-semibold tracking-wider uppercase text-sm">Desk Calendar</h3>
                <p className="text-white/80 text-xs mt-1 italic">Branding</p>
              </div>
              <div className="absolute inset-0 border-4 border-transparent group-hover:border-[#2eb8b8] pointer-events-none"></div>
            </div>
          )}
          ...
          {(activeFilter === 'All' || activeFilter === 'Photography') && (
            <div className="group relative overflow-hidden bg-white shadow-sm hover:shadow-md break-inside-avoid">
              ...
              <div className="absolute inset-0 bg-[#2eb8b8]/80 opacity-0 group-hover:opacity-100 flex flex-col items-center justify-center cursor-pointer">
                ...
                <h3 className="text-white mt-4 font-semibold tracking-wider uppercase text-sm">Mug Mockup</h3>
                <p className="text-white/80 text-xs mt-1 italic">Photography</p>
              </div>
              <div className="absolute inset-0 border-4 border-transparent group-hover:border-[#2eb8b8] pointer-events-none"></div>
            </div>
          )}
          ...
          {(activeFilter === 'All' || activeFilter === 'Illustration') && (
            <div className="group relative overflow-hidden bg-white shadow-sm hover:shadow-md break-inside-avoid">
              ...
              <div className="absolute inset-0 bg-[#2eb8b8]/80 opacity-0 group-hover:opacity-100 flex flex-col items-center justify-center cursor-pointer">
                ...
                <h3 className="text-white mt-4 font-semibold tracking-wider uppercase text-sm">Blue Lettering Notebook</h3>
                <p className="text-white/80 text-xs mt-1 italic">Illustration</p>
              </div>
              <div className="absolute inset-0 border-4 border-transparent group-hover:border-[#2eb8b8] pointer-events-none"></div>
            </div>
          )}
          ...
          {(activeFilter === 'All' || activeFilter === 'Branding') && (
            <div className="group relative overflow-hidden bg-white shadow-sm hover:shadow-md break-inside-avoid">
              ...
              <div className="absolute inset-0 bg-[#2eb8b8]/80 opacity-0 group-hover:opacity-100 flex flex-col items-center justify-center cursor-pointer">
                ...
                <h3 className="text-white mt-4 font-semibold tracking-wider uppercase text-sm">Logo Mockup</h3>
                <p className="text-white/80 text-xs mt-1 italic">Branding</p>
              </div>
              <div className="absolute inset-0 border-4 border-transparent group-hover:border-[#2eb8b8] pointer-events-none"></div>
            </div>
          ...
          {(activeFilter === 'All' || activeFilter === 'Web Design') && (
            <div className="group relative overflow-hidden bg-white shadow-sm hover:shadow-md break-inside-avoid">
              ...
              <div className="absolute inset-0 bg-[#2eb8b8]/80 opacity-0 group-hover:opacity-100 flex flex-col items-center justify-center cursor-pointer">
                ...
                <h3 className="text-white mt-4 font-semibold tracking-wider uppercase text-sm">T-Shirt Design</h3>
                <p className="text-white/80 text-xs mt-1 italic">Web Design</p>
              </div>
              <div className="absolute inset-0 border-4 border-transparent group-hover:border-[#2eb8b8] pointer-events-none"></div>
            </div>
          ...
          {(activeFilter === 'All' || activeFilter === 'Illustration') && (
            <div className="group relative overflow-hidden bg-white shadow-sm hover:shadow-md break-inside-avoid">
              ...
              <div className="absolute inset-0 bg-[#2eb8b8]/80 opacity-0 group-hover:opacity-100 flex flex-col items-center justify-center cursor-pointer">
                ...
                <h3 className="text-white mt-4 font-semibold tracking-wider uppercase text-sm">Crispy Logo</h3>
                <p className="text-white/80 text-xs mt-1 italic">Illustration</p>
              </div>
              <div className="absolute inset-0 border-4 border-transparent group-hover:border-[#2eb8b8] pointer-events-none"></div>
            </div>
          ...
          {(activeFilter === 'All' || activeFilter === 'Branding') && (
            <div className="group relative overflow-hidden bg-white shadow-sm hover:shadow-md break-inside-avoid">
              ...
              <div className="absolute inset-0 bg-[#2eb8b8]/80 opacity-0 group-hover:opacity-100 flex flex-col items-center justify-center cursor-pointer">
                ...
                <h3 className="text-white mt-4 font-semibold tracking-wider uppercase text-sm">Dark Business Card</h3>
                <p className="text-white/80 text-xs mt-1 italic">Branding</p>
              </div>
              <div className="absolute inset-0 border-4 border-transparent group-hover:border-[#2eb8b8] pointer-events-none"></div>
            </div>
          ...
          {(activeFilter === 'All' || activeFilter === 'Photography') && (
            <div className="group relative overflow-hidden bg-white shadow-sm hover:shadow-md break-inside-avoid">
              ...
              <div className="absolute inset-0 bg-[#2eb8b8]/80 opacity-0 group-hover:opacity-100 flex flex-col items-center justify-center cursor-pointer">
                ...
                <h3 className="text-white mt-4 font-semibold tracking-wider uppercase text-sm">Sands Print</h3>
                <p className="text-white/80 text-xs mt-1 italic">Photography</p>
              </div>
              <div className="absolute inset-0 border-4 border-transparent group-hover:border-[#2eb8b8] pointer-events-none"></div>
            </div>
